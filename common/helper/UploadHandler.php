...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => $this->get_server_var('DOCUMENT_ROOT').'/data/upload/files/'.date('Y').'/'.date('md').'/',
            'upload_url' => '/data/upload/files/'.date('Y').'/'.date('md').'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function set_additional_file_properties($file) {
        //$file->name = iconv("GBK", "UTF-8//IGNORE", $file->name);
