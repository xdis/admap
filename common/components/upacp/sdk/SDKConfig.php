...
// 签名证书路径
const SDK_SIGN_CERT_PATH = __DIR__.'/../certs/acp_test_sign.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = __DIR__.'/../certs/acp_test_enc.cer';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://127.0.0.1/yuntu2.0/www/web/test';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = 'http://120.24.51.71/upacp_demo_b2c/demo/api_01_gateway/BackReceive.php';

//文件下载目录 
const SDK_FILE_DOWN_PATH = __DIR__.'/../file/';

//日志 目录 
const SDK_LOG_FILE_PATH = __DIR__.'/../logs/';
